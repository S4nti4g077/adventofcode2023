...
// data.forEach((el) => {
//   const letters = el.toString().split("");
//   const numbers = [];
...
//   });
//   const sumOfNumbers = [];
//   sumOfNumbers.push(numbers[0]);
//   sumOfNumbers.push(numbers[numbers.length - 1]);
//   const endNumber = parseInt(sumOfNumbers.join(""));
//   totalSum.push(endNumber);
// });

// const sumFinal = totalSum.reduce(
...
// const inputString = (el) => {
//   const matches = el.match(/red|\b(?:1[2-9]\d{0,3}|[2-9]\d{2,3}|10000)\b/g);
//   if (matches) {
...
data1.forEach((el) => {
  ...
  const matches = el
    .split(";")
    .match(/red|\b(?:1[2-9]\d{0,3}|[2-9]\d{2,3}|10000)\b/g);
  if (matches) {
    console.log("Found matches:", matches);
  } else {
    console.log("No matches found.");
  ...
  splitted.forEach((el) => {
    const splittedAgain = el.split(",");
    // inputString(splittedAgain);
    console.log(splittedAgain);
  });
});
